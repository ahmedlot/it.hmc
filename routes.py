...
def register_routes(app):
    ...
    def inventory():
        ...
        # تحويل البيانات إلى الشكل المتوقع في القالب
        formatted_items = []
        for item in inventory_items:
            product, inventory = item  # فصل الكائنات من نتيجة الاستعلام
            
            formatted_item = {
                'product': product,  # كائن المنتج كامل
                'inventory': inventory  # كائن المخزون كامل
            }
            formatted_items.append(formatted_item)
        
        return render_template('inventory/index.html', inventory_items=formatted_items)
