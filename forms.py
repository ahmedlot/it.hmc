...
class InventoryItemForm(FlaskForm):
    """نموذج لعرض عناصر المخزون بالخصائص المناسبة"""
    product_id = IntegerField('رقم المنتج', render_kw={'readonly': True})
    product_name = StringField('اسم المنتج', render_kw={'readonly': True})
    current_quantity = IntegerField('الكمية الحالية', render_kw={'readonly': True})
    min_quantity = IntegerField('الحد الأدنى', render_kw={'readonly': True})
    purchase_price = FloatField('سعر الشراء', render_kw={'readonly': True})
    sale_price = FloatField('سعر البيع', render_kw={'readonly': True})
    category_name = StringField('التصنيف', render_kw={'readonly': True})
